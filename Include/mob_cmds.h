...
DECLARE_DO_FUN( do_mpgatransfer);
...
DECLARE_DO_FUN( do_mprecall    );
DECLARE_DO_FUN( do_mpremove    );
DECLARE_DO_FUN( do_mprestore   );
DECLARE_DO_FUN( do_mprstate    );
DECLARE_DO_FUN( do_mpsetpath   );
DECLARE_DO_FUN( do_mpsetquest  );
DECLARE_DO_FUN( do_mppeace     );
DECLARE_DO_FUN( do_mpsetowner  );
DECLARE_DO_FUN( do_mpostrname  );
DECLARE_DO_FUN( do_mpostrshort );
DECLARE_DO_FUN( do_mpostrlong  );
